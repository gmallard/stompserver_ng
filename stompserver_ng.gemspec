...
queues, queue monitoring, and basic authentication.}
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "STATUS", "bin/stompserver_ng", "client/README.txt", "client/both.rb", "client/consume.rb", "client/send.rb", "config/stompserver_ng.conf", "etc/19xcompat/notes.rdoc", "etc/passwd.example", "etc/ppqinfo.rb", "etc/runserver.sh", "etc/stompserver_ng", "etc/stompserver_ng.conf", "lib/stomp_server_ng.rb", "lib/stomp_server_ng/protocols/http.rb", "lib/stomp_server_ng/protocols/stomp.rb", "lib/stomp_server_ng/queue.rb", "lib/stomp_server_ng/queue/activerecord_queue.rb", "lib/stomp_server_ng/queue/ar_message.rb", "lib/stomp_server_ng/queue/ar_reconnect.rb", "lib/stomp_server_ng/queue/dbm_queue.rb", "lib/stomp_server_ng/queue/file_queue.rb", "lib/stomp_server_ng/queue/memory_queue.rb", "lib/stomp_server_ng/queue_manager.rb", "lib/stomp_server_ng/stomp_auth.rb", "lib/stomp_server_ng/stomp_frame.rb", "lib/stomp_server_ng/stomp_id.rb", "lib/stomp_server_ng/stomp_user.rb", "lib/stomp_server_ng/test_server.rb", "lib/stomp_server_ng/topic_manager.rb", "setup.rb", "stompserver_ng.gemspec", "test/devserver/props.yaml", "test/devserver/runserver.sh", "test/devserver/stompserver_ng.dbm.conf", "test/devserver/stompserver_ng.file.conf", "test/devserver/stompserver_ng.memory.conf", "test/noserver/mocklogger.rb", "test/noserver/test_queue_manager.rb", "test/noserver/test_stomp_frame.rb", "test/noserver/test_topic_manager.rb", "test/noserver/ts_all_no_server.rb", "test/props.yaml", "test/runalltests.sh", "test/runtest.sh", "test/test_0000_base.rb", "test/test_0001_conn.rb", "test/test_0002_conn_sr.rb", "test/test_0006_client.rb", "test/test_0011_send_recv.rb", "test/test_0015_ack_conn.rb", "test/test_0017_ack_client.rb", "test/test_0019_ack_no_ack.rb", "test/test_0022_ack_noack_conn.rb", "test/test_0040_receipt_conn.rb", "test/ts_all_server.rb"]
