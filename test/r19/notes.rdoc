...
# = Gem Build
#
# The author is having some difficulties with this, being a total novice
# at gems.
#
...
#
# * rake debug_gem | sed '/^(/d' > stompserver.gemspec
#
# However, after that the command:
#
# * rake gem
#
# fails.  Understanding and fixing this is a todo.
#
# A gem _can_ be built successfully with:
#
# * gem build stompserver.gemspec
#
# That gem can be subsequently installed through normal procedures.
#
# == Gem Todo List
#
# * Run gem installs on all versions of ruby (currently only done on 1.8.7)
#
# = Todo List
#
# * More unit tests
