...
#
class Test_0020_Ack_Ns_Reget_Noack < Test_0000_Base

  #
  def setup
    super
    @queue_name = "/queue/acknareget"
    @test_message = "Out in the west Texas town of El Paso ....."
    @reconnect_stagger = 1
  end
  ...
  def test_0010_ack_no_ack_reget
    ...
    assert_nothing_raised() {
      ...
      @client.subscribe(@queue_name,
        {"persistent" => true, "client-id" => "anareg_client_get" } ) do |message|
